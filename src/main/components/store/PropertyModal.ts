...
import {SimpleDropDownModel} from './SimpleDropDown';
...
export const PropertyItemModel = types
    .model('PropertyItem', {
        ...
        valueName: types.optional(types.string, ''),
...
export const PropertyControlModel = types
    ...
    .actions(self => {
        ...
        return {
            ...
            init(data: PropertyDataType[]) {
                ...
                data.forEach(item => {
                    const fieldModel: DataType = {
                        ...
                        propertyValue: responseData[item.valueName],
            ...
            sent(): void {
                const sentObj = Object.fromEntries(self.propertyData.map(n => [n.valueName, n.propertyValue]))
                console.log(sentObj)
            },
