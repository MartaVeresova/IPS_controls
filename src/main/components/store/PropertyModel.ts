...
import {lifeCycleLevelData} from '../options/controls/properties/lifeCycleLevel/LifeCycleLevelData';
import {objectTypesData} from '../options/controls/properties/objectTypes/ObjectTypesData';
...
export const PropertyControlModel = types
    ...
    .actions(self => ({
        init(data: PropertyDataType[], responseData: { [keys: string]: string | number | boolean | string[] | null }) {
    ...
    .actions(self => ({
        getLifeCycleLevelData(): void {
            ...
            self.init(lifeCycleLevelData, responseData)
        },
        getObjectTypesData(): void {
            // getObjectTypesData: flow(function* () {
            //     const response = yield fetch(`/api/objecttypes/2039`)
            ...
            const responseData = {
                ...
                deletedObjectLifetimeInDays: 2147483647,
